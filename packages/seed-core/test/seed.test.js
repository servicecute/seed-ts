...
import { asRefMarker, hashCanonical, refMarker, Registry, topologicalOrder, } from "../src/index.js";
function seed(name, deps = []) {
    return {
        name,
        scope: ["development"],
        dependsOn: deps,
...
describe("topologicalOrder", () => {
    it("emits the spec §13.6 worked example with alphabetical tie-break", () => {
        ...
        r.register("marketplace-listings", seed("marketplace-listings", ["demo-tenants", "billing-defaults"]));
