...
import { compareEventShapes, makeEvent, parseNdjson, } from "../src/index.js";
describe("parseNdjson", () => {
    it("skips comments and blank lines", () => {
        const parsed = parseNdjson("# comment\n\n{\"event\":\"x\",\"data\":{}}\n");
...
describe("compareEventShapes", () => {
    it("matches when names + data keys align", () => {
        const expected = parseNdjson('{"event":"runner.starting","data":{"verb":"apply"}}\n' +
...
//# sourceMappingURL=parity-diff.test.js.map